...
public class UIHandler : MonoBehaviour
{
    ...
    public void CalculateNewUIValues()
    {
        if (changeable)
        {
            ...
            int neededPlayersBridge1 = (int)(GameManager.Instance.airConsoleLogic.currentPlayers) + 2;
            ...
            int neededPlayersBridge2_1 = (int)(GameManager.Instance.airConsoleLogic.currentPlayers / 1.5) + 2;
            int neededPlayersBridge2_2 = (int)(GameManager.Instance.airConsoleLogic.currentPlayers / 3 ) + 2;
            ...
            int neededPlayersBridge3_1 = (int)(GameManager.Instance.airConsoleLogic.currentPlayers / 5) + 2;
            int neededPlayersBridge3_2 = (int)(GameManager.Instance.airConsoleLogic.currentPlayers / 1.5) + 2;
            int neededPlayersBridge3_3 = (int)(GameManager.Instance.airConsoleLogic.currentPlayers / 5) + 2;
